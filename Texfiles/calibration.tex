...
\label{sec:QG-syst}
\input{Texfiles/systematic-cali}
...
%The Quark and Gluon scale factors with uncertainty for each source of different quark \ntrk or BDT working points are estimated.  \Tab{tab:Quark0.5-ntrk} to \Tab{tab:Quark0.8-ntrk} show the quark scale factors for quark 50\% , 60\% , 70\% , 80\% \ntrk working point. \Tab{tab:Quark0.5-bdt} to \Tab{tab:Quark0.8-bdt} show the quark scale factors for quark 50\% , 60\% , 70\% , 80\% BDT working point. \Tab{tab:Gluon0.5-ntrk} to \Tab{tab:Gluon0.8-ntrk} show the gluon scale factors for quark 50\% , 60\% , 70\% , 80\% \ntrk working point. \Tab{tab:Gluon0.5-bdt} to \Tab{tab:Gluon0.8-bdt} show the gluon scale factors for quark 50\% , 60\% , 70\% , 80\% BDT working point. In general the systematic uncertainty for quark-jets SFs are smaller than that for gluon-jets, and both of them are dominated by the uncertainty due to parton showering. More details are shown in next section. 
