...
\begin{figure}[p]
	\centering
	\subfloat[] {\includegraphics[width=0.5\textwidth]{fig/tagging/quark_frac_selection_errors_6}}
	\subfloat[] {\includegraphics[width=0.5\textwidth]{fig/tagging/quark_frac_selection_errors_5}}\\
	\subfloat[] {\includegraphics[width=0.5\textwidth]{fig/tagging/quark_frac_selection_errors_4}}
...
\begin{figure}[p]
	\centering
	\subfloat[] {\includegraphics[width=0.5\textwidth]{fig/tagging/quark_frac_newFit_selection_errors_6}}
	\subfloat[] {\includegraphics[width=0.5\textwidth]{fig/tagging/quark_frac_newFit_selection_errors_5}}\\
	\subfloat[] {\includegraphics[width=0.5\textwidth]{fig/tagging/quark_frac_newFit_selection_errors_4}}
...
Although the BDT-tagger developed in Chapter~\ref{sec:5} have not been implemented in this analysis, the advanced capabilities of this tagger are expected to significantly improve the discrimination between quark and gluon-initiated jets, thereby enhancing the precision and reliability of dijet analyses in the future. 
