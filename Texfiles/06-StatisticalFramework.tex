...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\paragraph{Generation of pseudo-data\\}
...
%The statistical implementation is a bit different than previous dijet
%analyses and is in agreement with the current trigger-level analysis.
%Previously, a background model without nuisance parameters was fit to
%the data, and the resulting background fit parameters were used (and
%fixed) in the subsequent likelihood fits with nuisance parameters. In
