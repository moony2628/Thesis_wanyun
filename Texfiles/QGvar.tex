...
\begin{figure}[htb]
	\centering
	\subfloat[Forward region ]{\label{fig:QG-NtrkDataMCinclPythiaa}\includegraphics[width=0.45\textwidth]{fig/ADE/ROCs/ROC_500_Forward_none.pdf}} \quad
	\subfloat[Central region ]{\label{fig:QG-NtrkDataMCinclPythiab}\includegraphics[width=0.45\textwidth]{fig/ADE/ROCs/ROC_500_Central_none.pdf}}
	\caption[]{
...
\begin{figure}[htb]
	\centering
	\subfloat[Forward region ]{\label{fig:QG-NtrkDataMCinclPythiaa}\includegraphics[width=0.45\textwidth]{fig/ADE/ROCs/pt_Forward_GBDT_newScore.pdf}} \quad
	\subfloat[Central region]{\label{fig:QG-NtrkDataMCinclPythiab}\includegraphics[width=0.45\textwidth]{fig/ADE/ROCs/pt_Central_GBDT_newScore.pdf}}
	\caption[]{
