...
\begin{figure}[htb]
	\centering
	\subfloat[] {\includegraphics[width=0.45\textwidth]{fig/Systematics/quark_frac_selection_errors_HerwigAngularOrder_5.pdf}}
	\subfloat[] {\includegraphics[width=0.45\textwidth]{fig/Systematics/quark_frac_selection_errors_HerwigDipole_5.pdf}}
	%
...
\begin{figure}[htb]
	\centering
	\subfloat[] {\includegraphics[width=0.45\textwidth]{fig/Systematics/quark_frac_selection_errors_SherpaCSS_5.pdf}}
	\subfloat[] {\includegraphics[width=0.45\textwidth]{fig/Systematics/quark_frac_selection_errors_SherpaLund_5.pdf}}
	%
	\caption{The values of \ntrk~for 75\% quark (blue) and gluon (red) selection efficiencies in each \pt\ bin obtained with
		(a) Sherpa CSS, and 
...
\begin{table}[!htb]
	\begin{center}
		...
		\begin{tabular}{ccccc}
			\toprule
			\multicolumn{1}{c}{MC samples}   & \multicolumn{1}{c}{Truth-$g$ selection efficiency}   & \multicolumn{1}{c}{Truth-$q$ selection efficiency} &  \multicolumn{1}{c}{$c$}  &  \multicolumn{1}{c}{$m$} \\
			\midrule
