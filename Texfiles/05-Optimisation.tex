...
\begin{figure}[!htb]
        \centering
        \subfloat[Inclusive]{\includegraphics[width=0.35\columnwidth]{fig/yStarOptimization/New_Plots/Significance_QBH_mc16a+d+e_jj.pdf}}
        \subfloat[$\geq$1 g-tag]{\includegraphics[width=0.35\columnwidth]{fig/yStarOptimization/New_Plots/Significance_QBH_mc16a+d+e_gj.pdf}}
        \subfloat[2 g-tag]{\includegraphics[width=0.35\columnwidth]{fig/yStarOptimization/New_Plots/Significance_QBH_mc16a+d+e_gg.pdf}}
...
\begin{figure}[htb]
 \centering
 \subfloat[] {\includegraphics[width=0.5\textwidth]{fig/benchmark_signals/AccxEff_Hprime.pdf}}
 \subfloat[] {\includegraphics[width=0.5\textwidth]{fig/benchmark_signals/AccxEff_strings.pdf}}
