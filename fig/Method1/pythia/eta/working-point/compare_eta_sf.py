...
for wpoint in wpoint_array:
    ...
    #        if(bin[i] != 800):
                ...
                print("testflag:",higher_quark[10])
                """
...
hist_qsf_array[0].SetLineColor(4)
hist_qsf_array[0].SetMarkerStyle(23)
hist_qsf_array[0].SetMarkerSize(0.5)
hist_qsf_array[0].SetMarkerColor(4)
hist_qsf_array[0].SetLineStyle(7)

hist_qsf_array[1].SetLineColor(6)
hist_qsf_array[1].SetMarkerStyle(23)
hist_qsf_array[1].SetMarkerSize(0.5)
hist_qsf_array[1].SetMarkerColor(6)
hist_qsf_array[1].SetLineStyle(8)

hist_gsf_array[0].SetLineColor(2)
hist_gsf_array[0].SetMarkerStyle(21)
hist_gsf_array[0].SetMarkerSize(0.5)
hist_gsf_array[0].SetMarkerColor(2)
hist_gsf_array[0].SetLineStyle(7)

hist_gsf_array[1].SetLineColor(1)
hist_gsf_array[1].SetMarkerStyle(21)
hist_gsf_array[1].SetMarkerSize(0.5)
hist_gsf_array[1].SetMarkerColor(1)
hist_gsf_array[1].SetLineStyle(8)
from ROOT import *
...
leg.AddEntry(hist_qsf_array[0],"Quark Scale Factor:0<|\eta_{C}|<0.5,0.5<|\eta_{F}|<2.1","lp")
leg.AddEntry(hist_qsf_array[1],"Quark Scale Factor:0<|\eta_{C}|<2.1,0<|\eta_{F}|<2.1","lp")
leg.AddEntry(hist_gsf_array[0]," Gluon Scale Factor:0<|\eta_{C}|<0.5,0.5<|\eta_{F}|<2.1","lp")
leg.AddEntry(hist_gsf_array[1],"Gluon Scale Factor:0<|\eta_{C}|<2.1,0<|\eta_{F}|<2.1","lp")

hist_qsf_array[0].Draw("hist E0 L P0")
...
c.Print(eta_bin[0]+"_"+eta_bin[1]+"-compare-" + str(wpoint) +"-"+ str(var)+ ".pdf")
