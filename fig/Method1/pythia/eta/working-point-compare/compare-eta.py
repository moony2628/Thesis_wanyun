...
hist_qeff_array[0].SetLineColor(2)
hist_qeff_array[0].SetMarkerColor(2)
hist_qeff_array[0].SetMarkerSize(0.5)
hist_qeff_array[0].SetFillColor(2)
hist_qeff_array[0].SetFillStyle(3005)

hist_qeff_array[1].SetMarkerStyle(24)
hist_qeff_array[1].SetLineColor(1)
hist_qeff_array[1].SetMarkerColor(1)
hist_qeff_array[1].SetMarkerSize(0.5)
hist_qeff_array[1].SetFillColor(1)
...
hist_qsf_array[0].SetLineColor(2)
hist_qsf_array[0].SetMarkerStyle(25)
hist_qsf_array[0].SetMarkerSize(0.5)
hist_qsf_array[0].SetMarkerColor(2)
hist_qsf_array[0].SetLineStyle(7)

hist_qsf_array[1].SetLineColor(1)
hist_qsf_array[1].SetMarkerStyle(25)
hist_qsf_array[1].SetMarkerSize(0.5)
hist_qsf_array[1].SetMarkerColor(1)
hist_qsf_array[1].SetLineStyle(7)

scale = 1/rmax
hist_qsf_array[0].Scale(scale)
hist_qsf_array[1].Scale(scale)
hist_gsf_array[0].Scale(scale)
hist_gsf_array[1].Scale(scale)
from ROOT import *
c = TCanvas("","",500,500)
...
leg.AddEntry(hist_qeff_array[0],"Quark Efficiency:"+eta_start_central_1+"<|\eta_{C}|<"+eta_end_central_1+","+eta_start_forward_1+"<|\eta_{C}|<"+eta_end_forward_1,"lp")
leg.AddEntry(hist_qeff_array[1],"Quark Efficiency:"+eta_start_central_2+"<|\eta_{C}|<"+eta_end_central_2+","+eta_start_forward_2+"<|\eta_{C}|<"+eta_end_forward_2,"lp")
leg.AddEntry(hist_qsf_array[0],"Quark Scale Factor:"+eta_start_central_1+"<|\eta_{C}|<"+eta_end_central_1+","+eta_start_forward_1+"<|\eta_{C}|<"+eta_end_forward_1,"lp")
leg.AddEntry(hist_qsf_array[1],"Quark Scale Factor:"+eta_start_central_2+"<|\eta_{C}|<"+eta_end_central_2+","+eta_start_forward_2+"<|\eta_{C}|<"+eta_end_forward_2,"lp")

hist_qeff_array[0].Draw("L P0 E2")
hist_qeff_array[1].Draw("L P0 E2 same")
hist_qsf_array[0].Draw("hist E0 L P0 same")
hist_qsf_array[1].Draw("hist E0 L P0 same")
...
axis.Draw()
c.Print(eta_bin[0]+"_"+eta_bin[1]+"-Quark-" + str(wpoint) +"-"+ str(var)+ ".pdf")
...
hist_grej_array[0].SetMarkerSize(1)
...
hist_grej_array[1].SetMarkerSize(2)
...
hist_grej_array[1].SetLineColor(21)
...
leg.SetFillStyle(0)
leg.SetTextSize(0.018)
leg.AddEntry(hist_grej_array[0],"Gluon Rejection:"+eta_start_central_1+"<|\eta_{C}|<"+eta_end_central_1+","+eta_start_forward_1+"<|\eta_{C}|<"+eta_end_forward_1,"lp")
leg.AddEntry(hist_grej_array[1],"Gluon Rejection:"+eta_start_central_2+"<|\eta_{C}|<"+eta_end_central_2+","+eta_start_forward_2+"<|\eta_{C}|<"+eta_end_forward_2,"lp")
leg.AddEntry(hist_gsf_array[0],"Gluon Scale Factor:"+eta_start_central_1+"<|\eta_{C}|<"+eta_end_central_1+","+eta_start_forward_1+"<|\eta_{C}|<"+eta_end_forward_1,"lp")
leg.AddEntry(hist_gsf_array[1],"Gluon Scale Factor:"+eta_start_central_2+"<|\eta_{C}|<"+eta_end_central_2+","+eta_start_forward_2+"<|\eta_{C}|<"+eta_end_forward_2,"lp")

hist_grej_array[0].Draw("L P0 E2")
hist_grej_array[1].Draw("L P0 E2 same")
hist_gsf_array[0].Draw("hist E0 L P0 same")
hist_gsf_array[1].Draw("hist E0 L P0 same")
...
axis.SetTitle("Scale factor")
axis.Draw()
c1.Print(eta_bin[0]+"_"+eta_bin[1]+"-Gluon-" + str(wpoint) +"-"+ str(var)+ ".pdf")
